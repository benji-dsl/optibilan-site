...
const CATEGORY_MAP: Record<string, { label: string; icon: string; color: string }> = {
  cabinet: { label: 'Cabinet & Business', icon: 'chart', color: 'bleu-signature' },
  coaching: { label: 'Coaching & Performance', icon: 'zap', color: 'bleu-lecture' },
  sante: { label: 'Santé & Nutrition', icon: 'globe', color: 'bleu-ardoise' },
  tech: { label: 'Tech & IA', icon: 'brain', color: 'indigo' },
};
...
const STATIC_FALLBACK_ARTICLES: OptibilanArticle[] = [
  {
    ...
    category: 'cabinet',
    categoryLabel: 'Cabinet & Business',
    author: 'Marie Dubois',
  ...
  {
    slug: 'prepa-mentale-3-exercices-adherence',
    title: 'Prépa mentale : les 3 exercices qui boostent l\'adhérence à 80%+',
    excerpt: 'Étude sur 2000+ coachés : ceux qui ont un suivi prépa mentale restent engagés 40% plus longtemps. Les exercices transversaux qui fonctionnent.',
    content: '<p>Contenu complet de l\'article...</p>',
    category: 'coaching',
    categoryLabel: 'Coaching & Performance',
  ...
  },
  {
    ...
    excerpt: 'Configuration pas à pas de la sync santé via Raccourcis iOS ou n8n. 130+ biomarqueurs disponibles automatiquement dans le dossier coaché.',
    content: '<p>Contenu complet de l\'article...</p>',
    category: 'sante',
  ...
  {
    slug: 'ia-coaching-charte-ethique',
    title: 'IA dans le coaching : assistant, pas décideur — notre charte éthique',
    excerpt: 'L\'IA prépare, le professionnel décide. Structuration documents, synthèse bilans, identification des évolutions importantes. Le professionnel valide.',
    content: '<p>Contenu complet de l\'article...</p>',
    category: 'tech',
    categoryLabel: 'Tech & IA',
    author: 'Benjamin Sant',
    authorRole: 'CEO Optibilan',
    date: '11 mars 2024',
    readTime: '6 min',
    featured: true,
  },
